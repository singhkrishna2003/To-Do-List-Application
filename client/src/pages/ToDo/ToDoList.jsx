...
import { Divider, Empty, Input, Modal, Select, Tag, Tooltip, message } from 'antd';
...
function ToDoList() {
  ...
  // Get Dates and Time Values from Date and Time object
  ...
  // It's able to hnadlle Editable objects
  ...
  // It's able to hnadlle Delete objects
  ...
  // It's able to handle updation of Status 
  ...
  // It's able to handlle updatation of Tasks
    ...
    <>
      ...
      <section className={styles.toDoWrapper}>
        <div className={styles.toDoHeader}>
          <h2>Your Tasks</h2>
          <Input style={{ width: '62%' }} onChange={handleSearch} placeholder='Search Your Task Here...' />
          <div>
            <button onClick={() => setIsAdding(true)} className="primaryBtn" size="large">Add Task</button>
            <Select
          ...
          {filteredToDo.length > 0 ? filteredToDo.map((item) => {
            return (
              <div key={item?._id} className={styles.toDoCard}>
                ...
                {/* Edit or delete the task or marked as Incomplete */}
